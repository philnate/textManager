...
%---------------------------------------------------------------------------
% Bankverbindung
\setkomavar{frombank}{Kto. $accountNo\\
BLZ $bankNo\\
$bankName}
%---------------------------------------------------------------------------
%\setkomavar{yourref}{}
...
%---------------------------------------------------------------------------
\opening{Sehr geehrter $customer.male $customer.lastname,}
Für die, im $month von mir erstellten, Texte stelle ich Ihnen folgende Beträge in Rechnung.
Wie vereinbart, berechne ich Ihnen pro Wort ?1,5? Cent.
Bitte überweisen Sie den folgenden Rechnungsbetrag innerhalb von 14 Tagen auf das unten angegebene Konto.

\vspace{5pt}
\begin{tabular} {lrrr}%{*{4} {m{100pt}}} 
\hline
Leistung                                           & Wortzahl  & & Preis in \texteuro \\\hline
\rowcolor[gray]{0.9} Onlinetext Garderobenschränke & 299       & & 4,49  \\ 
                     Onlinetext kfw Anschlussfinanzierung     & 299       & & 4,49  \\ 
\rowcolor[gray]{0.9} Onlinetext OFM Manager        & 311       & & 4,67  \\ 
                     Onlinetext private Altersvorsorge & 303   & & 4,55      \\\hline
                                                   &           & Gesamtpreis & 18,20 \\ \hline\hline     
\end{tabular}

Als Kleinunternehmer besteht nach §19 UStG keine Umsatzsteuerpflicht.
\\




\closing{Mit freundlichen Grüßen,\\\includegraphics{ich.jpg}\\}
