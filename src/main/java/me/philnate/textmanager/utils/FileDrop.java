...
import me.philnate.textmanager.utils.FileDrop.TransferableObject;
 ...
 * </p>
 * 
 * @author Robert Harder (http://www.iharder.net/current/java/filedrop/)
...
public class FileDrop {
    ...
    private final boolean onlySelected = false;

    /** Discover if the running JVM is modern enough to have drag and drop. */
    private static Boolean supportsDnD;

    // Default border color
    private static Color defaultBorderColor = new java.awt.Color(0f, 0f, 1f,
	    0.25f);
